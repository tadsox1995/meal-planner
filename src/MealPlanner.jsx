...
// PIZZA NIGHT
  ...
  { id: 187, name: "Taco Soup", time: "30 min", protein: "3 lbs ground beef", emoji: "\uD83C\uDF72", tags: ["beef","rice","mexican"], ingredients: [{item:"ground beef",qty:"3 lbs",aisle:"Proteins"},{item:"beef broth",qty:"4 cups",aisle:"Canned"},{item:"diced tomatoes",qty:"2 cans",aisle:"Canned"},{item:"black beans",qty:"1 can",aisle:"Canned"},{item:"corn",qty:"1.5 cups",aisle:"Frozen"},{item:"taco seasoning",qty:"1 packet",aisle:"Pantry"},{item:"shredded cheese",qty:"2 cups",aisle:"Dairy"},{item:"sour cream",qty:"1 cup",aisle:"Dairy"},{item:"tortilla chips",qty:"1 bag",aisle:"Grains"}], steps:["Brown beef 7 min until no pink remains. Drain.","Add taco seasoning, broth, tomatoes, drained beans, corn.","Simmer 15 min. While it simmers, set out toppings.","Ladle into bowls.","Top with cheese, sour cream, crushed chips."], baby:"Beans, corn, beef from the pot — cooled, no chips.", quick:"Short on time? simmer just 10 min — it's done when everything's hot." },
                      ...
                      {meal.ingredients.map((ing, i) => {
                        ...
                        return (
                          ...
                          >
                            ...
                            <div style={{ fontSize: 13, color: "#333", textDecoration: checked ? "line-through" : "none" }}>{scaleQty(ing.qty, factorFor(meal))} {ing.item}{ing.optional ? <span style={{ color: "#b45309", fontSize: 11, marginLeft: 6, fontStyle: "italic" }}>(optional)</span> : null}</div>
                          </div>
                        );
                      })}
